...
from diffusion_policy_3d.policy.diffusion_gridmap_policy import DiffusionGridmapPolicy
...
class ScanDPWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionGridmapPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionGridmapPolicy = None
